...
import platformLogo from "../assets/platformlogo.avif";

const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal bg-base-300 text-neutral-content items-center p-4 fixed bottom-0">
      <aside className="grid-flow-col items-center">
        <img alt="logo" src={platformLogo} className="h-10 w-10 rounded-full"/>
        <p>Copyright © {new Date().getFullYear()} - All right reserved</p>
      </aside>
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <Link to='https://github.com/PratyakshaAmbig'>
        ...
        <Link to='https://www.linkedin.com/in/pratyaksha-ambig-1b3883225/'>
